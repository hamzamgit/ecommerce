...
class BannerModel(models.Model):
    ...
    banner_background_image = models.ImageField(upload_to='banner/bgimage')
...
class ProductDetailsModel(models.Model):
    ...
    def __str__(self):
        return '{}'.format(self.detail_title)


class RatingManager(models.Manager):

    def get_queryset(self):
        return super(RatingManager, self).get_queryset().order_by('-rating_time')


class RatingAndReviewModel(models.Model):
    rating_user = models.ForeignKey(User, on_delete=models.PROTECT)
    ...
    def __str__(self):
        return '{}'.format(self.rating_title)
